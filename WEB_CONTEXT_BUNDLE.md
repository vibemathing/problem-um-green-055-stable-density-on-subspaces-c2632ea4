...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-055-stable-density-on-subspaces-c2632ea4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-055"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-055-stable-density-on-subspaces-c2632ea4-v1",
      "problem_contract_sha256": "6ca1594808d82798cf836be6415995b86d89aa23bb43117e558d6150972ab90a",
      "problem_id": "problem:um-green-055-stable-density-on-subspaces-c2632ea4",
      "route_id": "route:um-green-055-stable-density-on-subspaces-c2632ea4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-055-stable-density-on-subspaces-c2632ea4-source-fidelity-01",
      "graph_id": "graph:um-green-055-stable-density-on-subspaces-c2632ea4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-055-stable-density-on-subspaces-c2632ea4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-055-stable-density-on-subspaces-c2632ea4-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $A \\subset \\mathbb{F}_2^n$. If $V$ is a subspace, write $\\alpha(V)$ for the density of $A$ on $V$. Is there some $V$ of moderately small codimension on which $\\alpha$ is stable?"
          },
          "statement_sha256": "62631799c8623818ca8dbc25909d356206726ad335a37e3d1bc7ff69cf251adf"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-055-stable-density-on-subspaces-c2632ea4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-055-stable-density-on-subspaces-c2632ea4-root",
      "route_id": "route:um-green-055-stable-density-on-subspaces-c2632ea4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-055-ef27c1f89858",
        "url": "https://www.unsolvedmath.com/problems/GREEN-055"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
